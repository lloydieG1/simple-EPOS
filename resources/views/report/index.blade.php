            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex flex-row space-x-4">
                        ...
                        <div class="mb-6">
                            <div class="flex flex-row space-x-8 ml-16">
                                <div class="">
                                    <h3 class="text-sm font-medium text-gray-700 mb-1">Total Agreements</h3>
                                    <p class="py-1 px-4 bg-gray-100 rounded-md shadow-sm text-2xl">{{ $overallMetrics['totalAgreements'] }}</p>
                                </div>
                                <div class="">
                                    <h3 class="text-sm font-medium mb-1">Gross Profit</h3>
                                    <p class="py-1 px-4 bg-gray-100 rounded-md shadow-sm text-2xl">£{{ $overallMetrics['grossProfit']  }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">£{{ number_format($staff->total_cost_price, 2) }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">£{{ number_format($staff->average_cost_price, 2) }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">£{{ number_format($staff->max_cost_price, 2) }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
